...
# This script installs Ubuntu with desktop environment and VNC server
...
print_header "Ubuntu Installation for Termux"
...
pkg install -y wget curl proot tar xz-utils pulseaudio

# Install additional packages for desktop
...
cd "$UBUNTU_DIR"
wget -O ubuntu-rootfs.tar.xz https://github.com/AndronixApp/AndronixOrigin/raw/master/Rootfs/Ubuntu/ubuntu-rootfs.tar.xz
